                ...
                <form class="form">
                    ...
                    <div class="form-body">
                        <div class="form-group" style="display: flex;">
                            ...
                            <a class="btn btn-outline-primary" href="{{route('user.ProfileName')}}" class=""> change</a>
                        </div>
                        <div class="form-group" style="display: flex;">
                            <label for="email" class="sr-only"></label>
                            <div id="email" class="form-control" name="email" >{{Auth::user()->email}}</div>
                            <a class="btn btn-outline-primary" href="{{route('user.ProfileEmail')}}" class=""> change</a>
                        </div>
                        <div class="form-group" style="display: flex;">
                            <label for="password" class="sr-only">Password</label>
                            <div id="password" class="form-control" name="password" >*********</div>
                            <a class="btn btn-outline-primary" href="#" class=""> change</a>
                        </div>
                    </div>
