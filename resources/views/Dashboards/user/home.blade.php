        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{asset('images/post/post-3.jpg')}}">
                            <div class="ml-3">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{asset('images/post/post-2.jpg')}}">
                            <div class="ml-3">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{asset('images/post/post-4.jpg')}}">
                            <div class="ml-3">
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="{{asset('images/post/post-5.jpg')}}" class="card-img-top" alt="post-thumb">
                        </div>
                        <div class="card-body">
                            ...
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{asset('images/kate-stone.jpg')}}" alt="Kate Stone">
                ...
                <div class="col-lg-8  mb-5 mb-lg-0">
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img  style="height:400px;widht:400px;overflow:hidden;" src="{{asset('ahmed1/' . $product->image)}}" class="card-img-top" alt="post-thumb">
                        </div>
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" > {{$product->name}}</a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author" >
                                ...
                                <li class="list-inline-item">
                                    <i class="ti-timer"></i>{{$product->reference}}
                                </li>
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <ul class="card-meta-tag list-inline">
                                        <li class="list-inline-item"><a href="tags.html">Quantité : {{$product->Qte}}</a></li>
                                        <li class="list-inline-item"><a href="tags.html">category : {{$product->category}}</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <p>{{$product->description}}</p>
                            <a  class="btn btn-outline-primary">{{$product->prix}}</a>
                        </div>
                    </article>
                @endforeach
                </div>
                <aside class="col-lg-4 sidebar-home">
                    ...
                    <div class="widget widget-author">
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="{{asset('images/john-doe.jpg')}}">
                            </div>
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="{{asset('images/kate-stone.jpg')}}">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="{{asset('images/john-doe.jpg')}}" alt="John Doe">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="widget">
                        <h4 class="widget-title">Recent Product</h4>

                        <!-- post-item -->
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="{{asset('images/post/post-10.jpg')}}">
                                <div class="ml-3">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="{{asset('images/post/post-7.jpg')}}">
                                <div class="ml-3">
                                    <h5><a class="post-title" href="post-details.html">Advice From a Twenty
                                            Something</a></h5>
                                    <ul class="card-meta list-inline mb-0">
