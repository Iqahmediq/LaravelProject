...
<div class="col-xl-8 col-md-12" style="margin-left: 220px">
    <div class="card">
        <div class="card-content">
            ...
            <div class="card-body">
                <form class="form" action="{{route('admin.storeProduct')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" rows="5" class="form-control square"
