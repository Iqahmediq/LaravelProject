                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <span class="avatar">
                                <img src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-2.png')}}"
                                    alt="avatar">
                            </span>
                            <span class="avatar">
                                <img src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-3.png')}}"
                                    alt="avatar">
                            </span>
                            <span class="avatar">
                                <img src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-4.png')}}"
                                    alt="avatar">
                            </span>
                        </div>
                    </div>
                        ...
                        <div id="carousel-area" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img src="{{asset('DashAdmin/theme-assets/images/carousel/08.jpg')}}"
                                        class="d-block w-100" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('DashAdmin/theme-assets/images/carousel/03.jpg')}}"
                                        class="d-block w-100" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('DashAdmin/theme-assets/images/carousel/01.jpg')}}"
                        ...
                        <div id="recent-buyers" class="media-list">
                                ...
                                <div class="media-left pr-1">
                                    <span class="avatar avatar-md avatar-online">
                                        <img class="media-object rounded-circle"
                                            src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-7.png')}}"
                                    ...
                                    <ul class="list-unstyled users-list m-0 float-right">
                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                src="{{asset('DashAdmin/theme-assets/images/portfolio/portfolio-1.jpg')}}"
                                                alt="Avatar">
                                        </li>
                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                src="{{asset('DashAdmin/theme-assets/images/portfolio/portfolio-2.jpg')}}"
                                                alt="Avatar">
                                        </li>
                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            data-original-title="Product 3" class="avatar avatar-sm pull-up">
                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                src="{{asset('DashAdmin/theme-assets/images/portfolio/portfolio-4.jpg')}}"
                                                alt="Avatar">
                                        </li>
                                    </ul>
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <span class="avatar avatar-md avatar-away">
                                        <img class="media-object rounded-circle"
                                            src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-8.png')}}"
                                            alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                                <div class="media-body w-100">
                                    ...
                                    <ul class="list-unstyled users-list m-0 float-right">
                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            data-original-title="Product 1" class="avatar avatar-sm pull-up">
                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                src="{{asset('DashAdmin/theme-assets/images/portfolio/portfolio-5.jpg')}}"
                                                alt="Avatar">
                                        </li>
                                        <li data-toggle="tooltip" data-popup="tooltip-custom"
                                            data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                            <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius"
                                                src="{{asset('DashAdmin/theme-assets/images/portfolio/portfolio-6.jpg')}}"
                                                alt="Avatar">
                                        </li>
                                    </ul>
                                    <p class="list-group-item-text mb-0">
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <span class="avatar avatar-md avatar-busy">
                                        <img class="media-object rounded-circle"
                                            src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-9.png')}}"
                                            alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <span class="avatar avatar-md avatar-online">
                                        <img class="media-object rounded-circle"
                                            src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-10.png')}}"
                                            alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                            ...
                            <a href="#" class="media border-0">
                                <div class="media-left pr-1">
                                    <span class="avatar avatar-md avatar-online">
                                        <img class="media-object rounded-circle"
                                            src="{{asset('DashAdmin/theme-assets/images/portrait/small/avatar-s-11.png')}}"
                                            alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
